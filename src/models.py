...
class AddressBook(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    first_name = db.Column(db.String(constants.FIRST_NAME_LENGHT), nullable=False)
    last_name = db.Column(db.String(constants.LAST_NAME_LENGHT), default="-")
    phone = db.Column(db.String(constants.PHONE_LENGHT), nullable=False)
    email = db.Column(db.String(constants.EMAIL_LENGHT), default="-")
    address = db.Column(db.String(constants.ADDRESS_LENGHT), default="-")
